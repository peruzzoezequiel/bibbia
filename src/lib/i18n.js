...
const UI = {
  pt: {
    ...
    hideBooks: 'Recolher os livros', showBooks: 'Mostrar os livros', books: 'Livros', chapters: 'Capítulos',
  ...
  en: {
    ...
    hideBooks: 'Collapse books', showBooks: 'Show books', books: 'Books', chapters: 'Chapters',
  ...
  es: {
    ...
    hideBooks: 'Ocultar libros', showBooks: 'Mostrar libros', books: 'Libros', chapters: 'Capítulos',
  ...
  it: {
    ...
    hideBooks: 'Nascondi libri', showBooks: 'Mostra libri', books: 'Libri', chapters: 'Capitoli',
  ...
  fr: {
    ...
    hideBooks: 'Masquer les livres', showBooks: 'Afficher les livres', books: 'Livres', chapters: 'Chapitres',
